...
// Global variables to track best solution - make them externally visible
// these will be used in the final print and comparison in recursion for
// best/optimal cutting list
...
void find_best_cut(cut_information *length_value_array, int rod_length,
    ...
    for (int ix = 0; ix < argument_array_length; ix++) {
        ...
        // decremented
        find_best_cut(length_value_array, rod_length - piece_length,
